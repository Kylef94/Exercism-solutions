...
namespace estate_executor {
    int assemble_account_number(int secret_modifier) {
        int khan_account = khan::bank_number_part(secret_modifier);
        int garcia_account = garcia::bank_number_part(secret_modifier);
        int zhang_account = zhang::bank_number_part(secret_modifier);
        return khan_account + garcia_account + zhang_account;
    }
    int assemble_code() {
